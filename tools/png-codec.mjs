/**
 * Dependency-free PNG codec shared by the story image generators.
 *
 * Decodes 8-bit RGB and RGBA PNGs, resamples by area averaging, and re-encodes
 * while preserving colour-profile chunks. Palette (colour type 3), 16-bit and
 * interlaced files are rejected rather than silently mangled.
 */
...
export { decodePng, resizeByArea, encodePng, pngSignature };

/**
 * Decodes the 8-bit RGB and RGBA PNG formats used by the story artwork.
 *
