...
continues to load root `style.css` only for the remaining legacy base and bottom-navigation rules.
...
`style.css` only for the remaining legacy base and bottom-navigation rules. Its large inline SVG markup
