...
| `stories/story1/end-matter.json` through `stories/story5/end-matter.json`, `story/6/end-matter.json` | Per-story Resources and optional Acknowledgments and References content | Organized; each JSON file is the only content source consumed by its story's runtime placeholder |
...
| Story 1 | Organized | Independent of the former root `style.css`; uses runtime shared end matter, the navigation-only shared Menu, shared story navigation, and fixed-Dark shared footer; `stories/story1/` owns Story 1 presentation, motion behavior, image, videos, and end-matter content; animated media shared with a prototype is under `shared/assets/` |
