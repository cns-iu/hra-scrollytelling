...
| Story 3 | Presentation and images organized | Uses the shared Nunito Sans narrative foundation, character-dialogue system, resource cards, two-link story navigation, navigation-only shared Menu, and fixed-Dark shared footer; `stories/story3/` owns its story-specific presentation and confirmed images, while cross-story artwork is under `shared/assets/images/`; embedded data remains deferred |
