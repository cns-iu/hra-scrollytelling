...
| `stories/story2/styles.css` | Story 2 scene, video, and legacy quiz presentation | Organized; its final section uses intrinsic height so shared story navigation and footer remain visible; Story 2 still loads root `style.css` for the remaining legacy page foundation and Story 2 color variables |
...
| `stories/story3/styles.css` | Story 3 scene and embedded-artwork presentation | Organized; Story 3 still loads root `style.css` for the remaining legacy page foundation |
...
| `stories/story5/styles.css` | Story 5 scene, animation, and media-control presentation | Organized; Story 5 still loads root `style.css` for the remaining legacy page foundation |
...
| Story 2 | Presentation and images organized | Uses the shared narrative foundation, character-dialogue system, resource cards, two-link story navigation, navigation-only shared Menu, and fixed-Dark shared footer; `stories/story2/` owns its story-specific presentation, quiz, and confirmed story-specific images; root `style.css` remains loaded only for the legacy page foundation and Story 2 color variables |
| Story 3 | Presentation and images organized | Uses the shared narrative foundation, character-dialogue system, resource cards, two-link story navigation, navigation-only shared Menu, and fixed-Dark shared footer; `stories/story3/` owns its story-specific presentation and confirmed images, while cross-story artwork is under `shared/assets/images/`; root `style.css` remains loaded only for the legacy page foundation; embedded data remains deferred |
