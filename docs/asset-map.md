...
| `stories/story3/styles.css` | Story 3 scene and embedded-artwork presentation | Organized; Story 3 uses the shared narrative page foundation and retains only a no-op root stylesheet link pending cleanup |
...
| `stories/story5/styles.css` | Story 5 scene, animation, and media-control presentation | Organized; Story 5 uses the shared narrative page foundation and retains only a no-op root stylesheet link pending cleanup |
