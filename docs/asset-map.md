...
| `stories/story2/styles.css` | Story 2 scene, video, and legacy quiz presentation | Organized; Story 2 still loads root `style.css` for the remaining legacy base and bottom-navigation rules |
...
| `stories/story3/styles.css` | Story 3 scene and embedded-artwork presentation | Organized; Story 3 still loads root `style.css` for the remaining legacy base and bottom-navigation rules |
...
| `stories/story5/styles.css` | Story 5 scene, animation, and media-control presentation | Organized; Story 5 still loads root `style.css` for the remaining legacy base and bottom-navigation rules |
...
| Story 2 | Presentation and images organized | Uses the shared narrative foundation, character-dialogue system, and resource cards, plus the navigation-only shared Menu and fixed-Dark shared footer; `stories/story2/` owns its story-specific presentation, quiz, and confirmed story-specific images; root `style.css` remains loaded only for the legacy base and bottom navigation |
| Story 3 | Presentation and images organized | Uses the shared narrative foundation, character-dialogue system, and resource cards, plus the navigation-only shared Menu and fixed-Dark shared footer; `stories/story3/` owns its story-specific presentation and confirmed images, while cross-story artwork is under `shared/assets/images/`; root `style.css` remains loaded only for the legacy base and bottom navigation; embedded data remains deferred |
...
| Story 5 | Presentation and media organized | Uses the shared narrative foundation, character-dialogue system, and resource cards, plus the navigation-only shared Menu and fixed-Dark shared footer; `stories/story5/` owns its story-specific presentation, accessibility stylesheet, confirmed story-specific images, and videos; root `style.css` remains loaded only for the legacy base and bottom navigation |
