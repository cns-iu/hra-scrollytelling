...
| `story/4/images/*.png` | Story 4 illustration rasters referenced by the inline SVGs | Downscaled in place to roughly twice their rendered size; regenerate with `npm run images:story4`, which is idempotent and skips any file the resample would enlarge |
